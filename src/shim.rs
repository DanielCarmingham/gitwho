...
pub fn shim_script(name: &str, gitfriend: &str, real: &str, target: ShimTarget) -> String {
    match target {
        ...
        ShimTarget::Windows => format!(
            "@echo off\r\n\
             REM Generated by gitfriend. Re-run `gitfriend shim install {name}` after\r\n\
