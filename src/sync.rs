...
//!
//! Everything here is written into gitfriend's own directory and nowhere else.
...
//! to preserve, no merge to get wrong, and removing gitfriend is deleting a
...
const HEADER: &str = "# This file is generated by gitfriend. Edits will be overwritten.\n\
                      # Change accounts.toml and re-run `gitfriend sync` instead.\n";
